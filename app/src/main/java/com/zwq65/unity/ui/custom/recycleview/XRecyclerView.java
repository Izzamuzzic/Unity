package com.zwq65.unity.ui.custom.recycleview;
...
public class XRecyclerView extends RecyclerView {
    ...
    private void init() {
        ...
        com.jcodecraeer.xrecyclerview.LoadingMoreFooter footView = new com.jcodecraeer.xrecyclerview.LoadingMoreFooter(getContext());
    ...
    public void loadMoreComplete() {
        isLoadingData = false;
        if (mFootView instanceof com.jcodecraeer.xrecyclerview.LoadingMoreFooter) {
            ((com.jcodecraeer.xrecyclerview.LoadingMoreFooter) mFootView).setState(com.jcodecraeer.xrecyclerview.LoadingMoreFooter.STATE_COMPLETE);
        } else {
    ...
    public void setNoMore(boolean noMore){
        ...
        isNoMore = noMore;
        if (mFootView instanceof com.jcodecraeer.xrecyclerview.LoadingMoreFooter) {
            ((com.jcodecraeer.xrecyclerview.LoadingMoreFooter) mFootView).setState(isNoMore ? com.jcodecraeer.xrecyclerview.LoadingMoreFooter.STATE_NOMORE: com.jcodecraeer.xrecyclerview.LoadingMoreFooter.STATE_COMPLETE);
        } else {
            mFootView.setVisibility(View.GONE);
        }
    }
    ...
    public void setLoadingMoreProgressStyle(int style) {
        ...
        if (mFootView instanceof com.jcodecraeer.xrecyclerview.LoadingMoreFooter) {
            ((com.jcodecraeer.xrecyclerview.LoadingMoreFooter) mFootView).setProgressStyle(style);
        }
    }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0
                ...
                isLoadingData = true;
                if (mFootView instanceof com.jcodecraeer.xrecyclerview.LoadingMoreFooter) {
                    ((com.jcodecraeer.xrecyclerview.LoadingMoreFooter) mFootView).setState(LoadingMoreFooter.STATE_LOADING);
                } else {
